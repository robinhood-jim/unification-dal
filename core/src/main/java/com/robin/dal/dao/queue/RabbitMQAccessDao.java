...
import com.robin.comm.resaccess.writer.RabbitMQResourceWriter;
...
public class RabbitMQAccessDao extends AbstractMessageQueryAccessDao implements IMessageQueueAccessDao {
    ...
    public void init(DataCollectionMeta collectionMeta) {
        ...
        if(!CollectionUtils.isEmpty(collectionMeta.getResourceCfgMap())){
            writer=new RabbitMQResourceWriter(collectionMeta);
